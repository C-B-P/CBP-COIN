                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Posq from zCbp"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCbp"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCbp));
