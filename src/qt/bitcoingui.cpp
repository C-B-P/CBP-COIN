                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cbp Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cbp address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cbp: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCBP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cbp Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cbp Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cbp"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cbp addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cbp addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cbp: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cbp Core help message to get a list with possible Cbp command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cbp Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cbp network", "", count));
}
...
{
    QString strTitle = tr("Cbp Core"); // default title
