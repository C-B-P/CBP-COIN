...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cbp features */
        {"cbp", "masternode", &masternode, true, true, false},
        {"cbp", "listmasternodes", &listmasternodes, true, true, false},
        {"cbp", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cbp", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cbp", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cbp", "masternodedebug", &masternodedebug, true, true, false},
        {"cbp", "startmasternode", &startmasternode, true, true, false},
        {"cbp", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cbp", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cbp", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cbp", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cbp", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cbp", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cbp", "mnbudget", &mnbudget, true, true, false},
        {"cbp", "preparebudget", &preparebudget, true, true, false},
        {"cbp", "submitbudget", &submitbudget, true, true, false},
        {"cbp", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cbp", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cbp", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cbp", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cbp", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cbp", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cbp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cbp", "checkbudgets", &checkbudgets, true, true, false},
        {"cbp", "mnsync", &mnsync, true, true, false},
        {"cbp", "spork", &spork, true, true, false},
        {"cbp", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cbp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cbpd, or the -server option to cbp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cbp-cli " + methodname + " " + args + "\n";
}
