...
In order to support loading of multiple wallets in cbp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cbp.cpp.
...
Changes to cbp.cpp
----------------------
cbp.cpp is the entry point into cbp-qt, and as such, will require some minor modifications to provide hooks for
