...
RESOURCES += src/qt/cbp.qrc src/qt/cbp_locale.qrc

TRANSLATIONS += src/qt/locale/cbp_bg.ts \
                src/qt/locale/cbp_de.ts \
                src/qt/locale/cbp_en.ts \
                src/qt/locale/cbp_es.ts \
                src/qt/locale/cbp_fi.ts \
                src/qt/locale/cbp_fr.ts \
                src/qt/locale/cbp_it.ts \
                src/qt/locale/cbp_ja.ts \
                src/qt/locale/cbp_pl.ts \
                src/qt/locale/cbp_pt.ts \
                src/qt/locale/cbp_ru.ts \
                src/qt/locale/cbp_sk.ts \
                src/qt/locale/cbp_sv.ts \
                src/qt/locale/cbp_vi.ts \
                src/qt/locale/cbp_zh_CN.ts \
                src/qt/locale/cbp_zh_TW.ts
