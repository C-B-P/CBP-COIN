...
This means one can have an always-on cbpd instance running, and another local cbpd/cbp-qt instance which connects to this node and receives blocks from it.
