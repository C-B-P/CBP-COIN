Contributing to Cbp Core
============================

The Cbp Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cbp Core project, and is not to be
confused with overall Cbp Network Protocol consensus changes.

Whether a pull request is merged into Cbp Core rests with the project merge
...
Patches that change Cbp consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cbp consensus, it must have been
...
The project leader is the release manager for each Cbp Core release.
